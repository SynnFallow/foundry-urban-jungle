 ...
 * @extends {ActorSheet}
 */
export class urbanjungleActorSheet extends ActorSheet {

    /** @override */
    static get defaultOptions() {
        return mergeObject(super.defaultOptions, {
            classes: ["urbanjungle", "sheet", "actor"],
            width: 800,
            height: 720,
    ...
    /** @override */
    get template() {
        const path = "systems/urbanjungle/templates/actor";
   ...
   */
    ...
    _onEncumbranceChange(event) {
        ...
        if (manageburdened) {
            ui.notifications.info(game.i18n.localize("urbanjungle.ui.encumbranceAutoActive"));
            return;
        }
    ...
    _onEffectsReset(event) {
        ...
        let confirmed = false;
        let dlog = new Dialog({
            title: game.i18n.localize("urbanjungle.dialog.statusResetConfirmation.title"),
            content: `
     <form class="urbanjungle">
      <span>${game.i18n.localize("urbanjungle.dialog.statusResetConfirmation.note")}</span>
     </form>
     `,
            buttons: {
                one: {
                    icon: '<i class="fas fa-check"></i>',
                    label: game.i18n.localize("urbanjungle.yes"),
                    callback: () => confirmed = true
                },
                two: {
                    icon: '<i class="fas fa-times"></i>',
                    label: game.i18n.localize("urbanjungle.no"),
